...
#ifndef __RIGHTWAY_DUMP_ERROR_HPP__
#define __RIGHTWAY_DUMP_ERROR_HPP__

#include <rightway/system/error_code.hpp>
#include <string>

namespace rightway { namespace dump { namespace error {
...
public:
    ...
    virtual inline std::string message(int value) const
    {
        ...
        {
        case error::no_dump:
            return "Failed to write dump file";
        case error::access_denied:
            return "Access denied to the dump file";
        }
...
inline rightway::system::error_code make_error_code(rightway::dump::error::basic_errors e)
{
    return rightway::system::error_code(
        static_cast<int>(e), rightway::dump::detail::get_basic_category());
}
